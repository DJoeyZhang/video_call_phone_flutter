              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage("lib/res/images/ic_launcher_round.png"),
                  ),
                  boxShadow: [
                    BoxShadow(
                      //左右、上下阴影的距离
...
//    else if (value != password) return "两次密码不一致";
  ...
  Future doRequest() async {
    ...
    //   ZToast.show(context: context, msg: visible ? "登录成功~" : "注册成功~");
    //   //跳转并关闭当前页面
    ...
    //   );
    // } else
    //   ZToast.show(context: context, msg: userMap['errorMsg']);
  }
}
